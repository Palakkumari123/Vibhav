...
const CurrentTeam = () => {
  ...
  return (
    <Layout>
      <div className="relative text-white min-h-screen p-4 pt-12 sm:pt-32 overflow-hidden">
        ...
        {/* Page Heading */}
        <h1 className="text-3xl sm:text-6xl font-extrabold text-center mb-6 sm:mb-16 font-batman tracking-widest uppercase text-[#5b8ef3] drop-shadow-[0_0_15px_rgba(91,142,243,0.9)]">
          Current Team
        </h1>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="w-full flex items-center justify-center mb-8 sm:mb-24 px-4">
            ...
            <div className="sm:hidden w-full max-w-[280px] relative">
              <select
                ...
                className="w-full bg-zinc-900/90 text-[#5b8ef3] border border-[#5b8ef3]/50 rounded-lg px-4 py-3 font-chakraBold appearance-none focus:outline-none shadow-lg"
              >
              ...
              <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-[#5b8ef3] text-xs">
                ▼
              </div>
            </div>

            {/* Desktop Navigation */}
            <div className="hidden sm:flex items-center bg-zinc-900/40 backdrop-blur-md rounded-full border border-white/10 px-10 py-5 gap-10 shadow-[0_0_30px_rgba(91,142,243,0.5)]">
              {Object.keys(Team).map((year) => (
                <button
                  key={year}
                  className={`px-8 py-3 rounded-full text-lg font-chakraBold transition-all duration-300 ${
                    selectedYear === year
                      ? "bg-[#5b8ef3] text-black shadow-[0_0_25px_#5b8ef3]"
          ...
          {/* Selected Year Label */}
          <div className="text-xl sm:text-4xl text-[#5b8ef3] font-chakraBold flex justify-center mb-10 text-center uppercase tracking-normal drop-shadow-[0_0_15px_rgba(91,142,243,0.9)] px-6">
