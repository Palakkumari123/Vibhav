  ...
  return (
    <Layout>
      <div className="flex justify-center flex-col">
        <div className="mt-12 text-[#edc161] justify-center flex font-[Quicksand] md:p-0 pl-1 text-4xl md:text-5xl">
          {currentPage}
        </div>
        ...
        <div className="text-3xl  mt-12 text-center text-[#edc161] font-[Hero-bold]">
          Workshops
        </div>
        <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 font-[Azonix] py-5 lg:gap-6 md:gap-3 lg:px-12 md:px-6 px-5">
          {ourwork
