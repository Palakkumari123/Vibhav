            ...
            <div className=" lg:py-12  mb-12  rounded-xl sm:mt-4 lg:px-1 z-10 bg-opacity-50  max-w-screen-md basis-2/3 lg:w-12">
              ...
              >
                <div>
                  <label
                    htmlFor="email"
                    className=" mb-2   text-gray-400 dark:text-gray-300"
                  >
                    Your email
                  </label>
                  <input
                    type="email"
                    id="email"
                    className="shadow-sm font-sans  border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 bg-gray-500/20 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                    name="email"
                    required
                  />
                </div>
                ...
                <div>
                  <label
                    htmlFor="subject"
                    className="block mb-2 text-gray-400 dark:text-gray-300"
                  >
                    Subject
                  </label>
                  <input
