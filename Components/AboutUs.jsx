...
export default function AboutUs() {
    return (
        <section className="relative flex items-center justify-center md:h-full" >
          ...
          <div className="flex flex-col w-4/5 h-full mb-8 bg-gray-700 center md:pb-24 rounded-t-2xl md:mb-24 " >
            <div className="w-full h-10 bg-black bg-opacity-40 rounded-t-2xl">
              ...
              <div className="flex flex-col">
                ...
                <p style={{fontFamily : 'Hero-Bold'}} className="text-gray-400 text-sm pb-4 md:text-xl p-4 md:p-12 font-[Nidsans-webfont]  text-justify" >
