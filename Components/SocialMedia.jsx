    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="flex flex-wrap justify-center">
        ...
        <a
          ...
          href="https://www.instagram.com/team_vibhav/" target="_blank"
        >
        ...
        <a
          ...
          aria-label="Facebook"
          href="https://m.facebook.com/262566097142744/" target="_blank"
        >
        ...
        <a
          ...
          href="https://discord.gg/cc3j3GbCrX" target="_blank"
        >
        ...
        <a
          ...
          aria-label="LinkedIn"
          href="https://www.linkedin.com/company/team-vibhav" target="_blank"
        >
          <FaLinkedin className="w-7 h-7 md:w-10 md:h-10" />
        </a>
      </div>

      {/* Weekly Updates Button */}
